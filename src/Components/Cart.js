...
const Cart = () => {
  ...
  const handleEmailConsult = () => {
    ...
    window.location.href = `mailto:servielectric-ventas@hotmail.com?subject=Consulta de Carrito&body=${emailBody}`;
  };
  ...
  const handleWhatsAppConsult = () => {
    const message = `Detalles del carrito:\n\n${cart
      ...
      .join("\n")}\n\nSubtotal: $${calculateSubtotal()}`;
    window.location.href = `https://wa.me/+503 7640 7144?text=${encodeURIComponent(
      message
      ...
      {cart.length === 0 ? (
        ...
        <div>
          ...
          <div className="button-group">
            <button onClick={handleConsult} className="consult-button">
              Consultar
            </button>
      ...
      >
        <h2>
          {clearCartConfirm
            ...
            : "¿Estás seguro de que quieres eliminar este ítem del carrito?"}
        </h2>
        <div className="modal-buttons">
          <button
            onClick={
              clearCartConfirm ? handleConfirmClearCart : handleConfirmRemove
            }
      ...
      >
        <div className="modal-content">
          ...
          <form onSubmit={handleSubmit}>
            ...
            />{" "}
            {/* Agrega los ítems al formulario */}
          ...
          {showThankYouMessage && (
            <p className="thank-you-message">¡Gracias por tu consulta!</p>
          )}
        </div>
      </Modal>
    </div>
